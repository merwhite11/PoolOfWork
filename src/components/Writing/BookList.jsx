...
const BookList = () => {
  ...
  var blinkingSumm =
    "A memory-inspired short story written in English and Spanish. Explores themes of religion, childhood and the transformation of a story through the filters of time and language.";
  var bobbySum =
    "A short short story inspired by real life, a love for bikes and the streets of San Francisco.";
  ...
  const books = [
    ...
    [
      ...
      blinkingSumm,
      "cuento",
      "Story Twice Told // Cuento Dos Veces Contado",
    ],
